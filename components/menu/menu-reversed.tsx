...
const MenuSectionReversed: React.FC<MenuSectionProps> = ({ items }) => {
  ...
  return (
    <section ref={sectionRef} className="w-full max-w-[1400px] mx-auto relative">
      <div className="md:relative flex flex-col flex-row-reverse flex-row justify-between">
             {/* Imagem */}
             <motion.div
          style={{ y: isInView ? imageY : "auto" }}
          className="w-full md:w-[40%] right-[0] md:absolute flex items-center justify-center"
        >
          <Image
            src={pizza}
            alt="Delicious Pizza"
        ...
        <motion.div
          ...
          className="w-full md:w-[65%] h-auto rounded-[24px] p-4 md:p-6 bg-[#fbd605] relative md:relative md:right-[0]"
        >
...
export default MenuSectionReversed;
